...
export default function ApAgingPage(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6 p-4 lg:p-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-[var(--color-foreground)]">AP Aging Report</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-4">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
              ...
              <div className="space-y-1">
                <p className="text-xs font-medium uppercase tracking-wide text-[var(--color-overdue)]">
                  Over 90 Days
                </p>
                <MoneyDisplay amount={moneyAmount(report.buckets.over90)} size="md" />
              </div>
              <div className="space-y-1">
                <p className="text-xs font-medium uppercase tracking-wide text-[var(--color-foreground)]">
                  Total
                </p>
                      ...
                      <>
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-right">
                            <MoneyDisplay amount={moneyAmount(vendor.current)} size="sm" />
                          </td>
                          <td className="px-4 py-3 text-right">
                            <MoneyDisplay amount={moneyAmount(vendor.days1to30)} size="sm" />
                          </td>
                          <td className="px-4 py-3 text-right">
                            <MoneyDisplay amount={moneyAmount(vendor.days31to60)} size="sm" />
                          </td>
                          <td className="px-4 py-3 text-right">
                            <MoneyDisplay amount={moneyAmount(vendor.days61to90)} size="sm" />
                          </td>
                          <td className="px-4 py-3 text-right">
                            <MoneyDisplay amount={moneyAmount(vendor.over90)} size="sm" />
                          </td>
                          <td className="px-4 py-3 text-right font-medium">
                            <MoneyDisplay amount={moneyAmount(vendor.total)} size="sm" />
                          </td>
                        </tr>
                        {expandedVendor === vendor.vendorId && vendor.bills.map((bill) => (
                          <tr
                          ...
                          >
                            ...
                            <td className="px-4 py-2 text-right">
                              <MoneyDisplay amount={BigInt(bill.outstandingSatang)} size="sm" />
                            </td>
                          </tr>
                        ))}
                      </>
